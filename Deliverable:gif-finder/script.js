...
function sendApiRequest() {
    ...
    fetch("https://api.giphy.com/v1/gifs/search?api_key=z0Psh9Izesmx6mij0PIyrktr5hkE7M8A&q=spongebob&limit=25&offset=0&rating=G&lang=en")
    .then(function(data) {
      return data.json();
    })
    .then(function(json) {
...
function addImageToScreen(myURL) {
  ...
  let  wrapper.querySelect('#wrapper')
  wrapper.innerHTML()=<img src = ''>
